...
<body>
    ...
    $sqlQuery = "SELECT * FROM cocktail.mytable
        WHERE ingredients0ingredient LIKE '%$ingrediente%' 
        OR ingredients1ingredient LIKE '%$ingrediente%'
        OR ingredients2ingredient LIKE '%$ingrediente%'
        OR ingredients3ingredient LIKE '%$ingrediente%'
        OR ingredients4ingredient LIKE '%$ingrediente%'"; //query da fare al database
    ...
    if ($risultato->num_rows > 0) {
        ...
        echo "<p class=\"sorry\">Sorry, no cocktail found with this ingredient.</p>";
    }
